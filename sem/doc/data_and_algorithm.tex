...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}	
	\caption{Three dimensional representation of the data. Each 30 second segment is represented by a dot in the color corresponding to the sleep stage this segment is assigned to.}
