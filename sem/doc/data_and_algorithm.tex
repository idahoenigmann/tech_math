...
\begin{figure}
	\centering	
	\begin{tikzpicture}
		\begin{axis}[xlabel=principal component 1, ylabel=principal component 2, zlabel=principal component 3, width=0.8\textwidth, height=0.3\textwidth, view/az=-45, view/el=45, legend entries={awake, REM, S3, S2, S1}, legend pos=outer north east, z post scale=3.5]
