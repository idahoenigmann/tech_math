...
\begin{figure}
	...
	\begin{subfigure}{0.8\linewidth}
		...
		\caption{Clearly the relationship in this figure is non-linear. PCA cannot describe circular dependencies, as shown in this data.}
